...
def get_suggestions(user_history, user_entry: str):
    ...
    # get list of 10 suggestions by querying LLM
    suggestion_list = generate_LLM_suggestions(user_entry)
...
""" Returns a list of 10 suggestions generated by an LLM based on user entry
    Param: the user entry, a string of text entered into journal entry
    Returns: a list of strings, 10 wellbeing activity suggestions generated by an LLM
    based on the user's journal entry
"""
def generate_LLM_suggestions(user_entry: str):
